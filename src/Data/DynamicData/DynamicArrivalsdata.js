export function DynamicStaticArrivalsdata(data, element) {
  console.log(data);
  ...
  if (data) {
    article.innerHTML = data
      ...
      <div class="arrivals-data1  flex flex-col gap-2 w-full">
                  <div class="arrival-box bg-white dark:bg-box-glass  rounded-sm flex h-auto w-full items-center justify-start gap-6 p-2">
    ...
    article.innerHTML = `<h1>No data</h1>`;
  }

  element.append(article);
}
export function DynamicStaticArrivalsdata2(data, element) {
  let article = document.createElement("article");
  if (data) {
    article.innerHTML = data
      .map(({ id, img, newarrivalproductname, actualprice, offerprice }) => {
