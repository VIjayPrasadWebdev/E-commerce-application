export function DynamicStaticTrendingdata(data, element) {
  console.log(data);
  ...
  article.innerHTML = data
    .map(({ id, img, newarrivalproductname, actualprice, offerprice }) => {
      ...
      <div class="trending-data1   flex flex-col gap-2 w-full">
                  <div class="trending-box bg-white dark:bg-box-glass  rounded-sm flex h-auto w-full items-center justify-start gap-6 p-2">
...
export function DynamicStaticTrendingdata2(data, element) {
  let article = document.createElement("article");
  article.innerHTML = data
    .map(({ id, img, newarrivalproductname, actualprice, offerprice }) => {
      return `<div class="trending-data2 flex flex-col gap-2 w-full">
                  <div class="trending-box bg-white dark:bg-box-glass  rounded-sm flex h-auto w-full items-center justify-start gap-6 p-2">
              <div class="img h-20 w-20 bg-gray-100 rounded-sm" data-id=${id}>
               <img src=${img} alt="pic" class="h-full w-full object-cover rounded-sm p-1">
              </div>
